      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
            Ready to collaborate on your next mobile project? Let&apos;s discuss how I can help bring your ideas to life.
          </p>
        </div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-700 dark:text-gray-300 mb-8 leading-relaxed">
                ...
                Whether you&apos;re looking for a React Native developer for your team or 
                need help with a mobile app project, I&apos;d love to hear from you.
              </p>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400">phongdev95@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400">+84 965 363 228</p>
                </div>
              </div>
            ...
            <div className="pt-8">
              ...
              <div className="flex space-x-4">
                <a 
                  href="https://github.com/phongmc95" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="w-12 h-12 bg-gray-900 dark:bg-gray-700 rounded-lg flex items-center justify-center hover:bg-gray-800 dark:hover:bg-gray-600 transition-colors"
                >
                ...
                <a 
                  href="https://linkedin.com/in/phongvh95" 
                  target="_blank" 
                  rel="noopener noreferrer"
          ...
          <div className="bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-2xl p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 disabled:from-gray-400 disabled:to-gray-500 text-white font-semibold py-4 px-6 rounded-lg transition-all duration-300 transform hover:scale-105 disabled:scale-100 disabled:cursor-not-allowed"
              >
                {isSubmitting ? (
